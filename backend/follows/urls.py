...
from .views import follow_user, unfollow_user, check_follow_status, accept_follow_request, pending_follow_requests
...
urlpatterns = [
    ...
    path("requests/", pending_follow_requests, name="follow-requests"), 
]